    ...
    <>
      <div className="sm:w-full h-full -z-10" id="about">
        <div className=" mt-16 sm:mt-0  sm:w-[620px]  md:w-full  absolute flex flex-col">
          ...
          <h1 className="ml-3 text-[35px] sm:text-[40px] -mt-4 max-w-fit  pl-3 text-red-400 font-mono">
            We're a Team of 3
          </h1>
          <p className="w-[350px]  sm:w-full text-[30px] sm:text-[40px] -mt-8 sm:-mt-4  md:-mt-4 pt-3 ml-3   h-[70px]  font-mono pl-2 text-red-400">
            Designers,thinkers & collaborators
          </p>
          <h1 className="ml-[180px] sm:ml-[160px] mb-6  mt-20 md:mt-0  xl:ml-[10px]  text-[40px] xl:mb-2 font-mono text-6xl max-w-fit text-red-300 border-b-2 border-gray-400">
            our team
          </h1>
